...
class Add2AppNavigator {
  ...
  ///
  /// Call this once per page, typically in `add2appMain` before `runApp`.
  ...
  /// Decode the `initialRoute` string (set by Android) back into
