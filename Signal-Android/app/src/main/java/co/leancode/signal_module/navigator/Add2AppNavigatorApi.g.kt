...
interface Add2AppNavigatorHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: Add2AppNavigatorHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.signal_module.Add2AppNavigatorHostApi.push$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.signal_module.Add2AppNavigatorHostApi.pop$separatedMessageChannelSuffix", codec)
        if (api != null) {
