...
const _flutterRouteAnnotations = ['InlayFlutterRoute'];
const _flutterDialogAnnotations = ['InlayFlutterDialog'];
const _nativeRouteAnnotations = ['InlayNativeRoute', 'inlayNativeRoute'];
const _storeAnnotations = ['InlayStore', 'inlayStore'];
const _storeKeyFieldAnnotations = ['InlayStoreKey', 'inlayStoreKey'];

/// Parses a Dart schema file and extracts definitions from annotations.
///
/// Looks for:
/// - `@InlayFlutterRoute()` or `@inlayFlutterRoute`
/// - `@InlayNativeRoute()` or `@inlayNativeRoute`
/// - `@InlayStore()` or `@inlayStore`
