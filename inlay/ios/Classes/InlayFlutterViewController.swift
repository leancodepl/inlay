...
/// Generic Flutter view controller used by `InlayNavigator` for every page.
///
/// Developers never subclass this or reference it directly — they call
/// `InlayNavigator.shared.push(from:page:)` and this VC is created
/// automatically.
///
/// Equivalent of Android's `InlayFlutterActivity`.
public final class InlayFlutterViewController: FlutterViewController {

    /// The page this VC is displaying (set by `InlayNavigator`).
    public var page: PageSettings?

    /// Optional custom pop handler. When set (e.g. by `InlayFlutterView`),
...
extension InlayFlutterViewController {
