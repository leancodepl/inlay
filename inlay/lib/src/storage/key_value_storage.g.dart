...
class KeyValueStorageHostApi {
  ...
  Future<void> put(StorageEntry entry) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.put$pigeonVar_messageChannelSuffix';
  ...
  Future<void> putAll(List<StorageEntry> entries) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.putAll$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<StorageEntry?> get(String key) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.get$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<StorageEntry>> getByPrefix(String prefix) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.getByPrefix$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> remove(String key) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.remove$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> removeByPrefix(String prefix) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.removeByPrefix$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<StorageEntry>> getAll() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.getAll$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> clear() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.inlay.KeyValueStorageHostApi.clear$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class KeyValueStorageFlutterApi {
  ...
  static void setUp(
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.inlay.KeyValueStorageFlutterApi.onStorageChanged$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
