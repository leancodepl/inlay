...
class NotificationPreferences {
  const NotificationPreferences({required this.sound, required this.vibration});

  final String sound;
  final bool vibration;

  List<Object?> encode() => <Object?>[sound, vibration];
...
class UserPreferencesStore
    implements InlaySnapshotStore<UserPreferencesStoreSnapshot> {
  ...
  Future<void> writeSnapshot(
    ...
    entries.add(
      StorageEntry(key: _key('tags'), value: jsonEncode(snapshot.tags)),
    );
    entries.add(
      StorageEntry(
        key: _key('notificationPreferences'),
        value: snapshot.notificationPreferences != null
            ? jsonEncode(snapshot.notificationPreferences!.encode())
            : jsonEncode(null),
      ),
    );
    if (entries.isNotEmpty) {
