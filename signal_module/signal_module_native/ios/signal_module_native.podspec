Pod::Spec.new do |s|
  s.name             = 'signal_module_native'
  s.version          = '0.1.0'
  s.summary          = 'Companion plugin for signal_module — holds generated native code.'
  s.description      = <<-DESC
Companion plugin for signal_module. Holds generated native code (Routes, Stores)
